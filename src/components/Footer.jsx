  ...
  return (
    <footer className="footer footer-center p-10 text-neutral-300 rounded bg-white/5 border-t border-white/10 backdrop-blur-md">
        <nav className="grid grid-flow-col gap-4">
          ...
          <Link className="hover:text-white" to="/updates">Latest Updates</Link>
          <Link className="hover:text-white" to="/about-us">About us</Link>
          ...
          <div className="grid grid-flow-col gap-4">
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current opacity-80 hover:opacity-100 transition-opacity"
              >
