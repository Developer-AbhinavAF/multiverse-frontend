...
import Perplexity_Logo from "../assets/perplexity.avif"
...
export default function PerplexityPromoModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center px-4">
      <div className="absolute inset-0 bg-black/70 backdrop-blur-sm overlay-fade" onClick={onClose} />
      <div className="relative w-full max-w-3xl rounded-2xl border border-white/10 bg-[rgba(18,18,18,0.9)] shadow-2xl modal-appear">
        <div className="p-6 sm:p-8">
          <div className="flex items-center gap-4 mb-4">
            <img src={Perplexity_Logo} alt="Perplexity" className="h-8 rounded sm:h-10 logo-hover" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="rounded-xl overflow-hidden border border-white/10 bg-gradient-to-br from-cyan-500/15 via-transparent to-white/5 p-4 hover-lift">
                <div className="aspect-video rounded-lg bg-gradient-to-br from-neutral-900 to-neutral-800 flex items-center justify-center">
                  <img src={LOGO_URL} alt="Perplexity Logo" className="h-22 rounded opacity-90" />
                </div>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-black font-semibold px-4 py-2 transition-colors hover-glow w-full sm:w-auto"
                >
                  Get 1 month free
                </a>
                <button
                  onClick={onClose}
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/15 hover:border-white/25 text-neutral-200 font-medium px-4 py-2 transition-colors hover-lift w-full sm:w-auto"
                >
                  Maybe later
                </button>
              </div>
